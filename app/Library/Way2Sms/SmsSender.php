...
namespace App\Library\Way2Sms;

/**
* Verify user using otp, sending via way2sms
*/
class SmsSender
{
	public function send_sms($userID, $userPWD, $recerverNO, $message)
    {
	    ...
	    $temp_file        = "../public/temporary1.txt";
	    ...
	    {
	        // echo 'Operation completed without any errors before login';
	    }
	    ...
	    {
	        // echo 'Operation completed without any errors after sending sms';
	    }
	    curl_close($ch);
